            ...
            <div className="hi-section">
                <div className="social-medias">
                    <div className="list-of-medias">
                        ...
                        <a className="media" style={{ animationDelay: ".6s" }} href="https://github.com/NicoHeinola" target="_blank" rel="noreferrer">
                            <img className="icon" src="icons/linkedin.png" />
                        </a>
                        <a className="media" style={{ animationDelay: ".7s" }} href="https://github.com/NicoHeinola" target="_blank" rel="noreferrer">
